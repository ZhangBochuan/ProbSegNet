...
import sys
sys.path.append("/root/data1/zbc/erfnet_pytorch/train") 
from erfnet_proto_stdc import Net
...
def main(args):
    ...
    for step, (images, labels, filename, filenameGt) in enumerate(loader):
        ...
        filenameSave = f"./{savedir}/" + filename[0].split("leftImg8bit/")[1]
...
if __name__ == '__main__':
   ...
   # parser.add_argument('--state')
    ...
    parser.add_argument('--saveDir',default="save_color")
